...
void MemAgent::VEGFRresponse(void) {
    ...
    //SAMRA APREDICT study
    //convert nM to percent effect on vegfr2 downreg. we know IC50 is 0.2, 50% inhibition of vegr2 activity with this. So assue anything over 0.04 is full inhib. 
   drugEffect_VR2 = DrugSupplied_tumour_nM/(DrugSupplied_tumour_nM+IC50); //(DrugSupplied_tumour_nM/0.2)*0.5;
   if(drugEffect_VR2>1.0f) drugEffect_VR2=1.0f;

   //cout<<" drugEffect: "<<drugEffect_VR2<<endl;
    VEGFRactive = VEGFRactive*(1-drugEffect_VR2);
