...
//    dataFile3.open("S&P.txt");
    ...
    VEGFgradient = readInGradient;//GRADIENT;
   // cout<< "gradient"<<VEGFgradient <<endl;
...
//    dataFile3.open("S&P.txt");
    ...
    for(i=0;i<APREDICT_slidingWindow;i++){
		sliding_Window_supplyScore.push_back(0.0f);
	}

     VEGFgradient = readInGradient;//VEGFgradient = GRADIENT;
