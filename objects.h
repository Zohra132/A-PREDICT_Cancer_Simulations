...
#define ANALYSIS_JTB_SP_PATTERN true ///stability score pattern score tip cell number
...
//Samra anti-VEGF APREDICT study variables
#define ANALYSIS_APREDICT true
extern float DrugSupplied_tumour_nM;
extern float accumulated_DrugDose_Gut;
extern float accumulated_DrugDose_Blood_mgL;
extern float accumulated_DrugDose_Blood_nM;
extern float DrugHalfLife;
extern float DrugAbsorption;
extern float drugEffect_VR2;
//extern float slidingWindowVascularProfile;
extern int drug_delivery_schedule;
#define APREDICT_slidingWindow  480
extern float dailyDose;
extern float VD_F;
extern float IC50;
extern int readInGradient;
...
//#endif
    ...
    //APREDICT functions/variables
    float APREDICT_Supply_lines_Score(void);
    std::vector <float> sliding_Window_supplyScore;
    float supplyLine_Score;
